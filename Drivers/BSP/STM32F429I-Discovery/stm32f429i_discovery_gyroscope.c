...
{  
  ...
  {	
    ...
    Gyro_InitStructure.Full_Scale       = L3GD20_FULLSCALE_250;	//CHANGED - original L3GD20_FULLSCALE_500
    ...
    Gyro_FilterStructure.HighPassFilter_Mode_Selection   = L3GD20_HPM_NORMAL_MODE_RES;	//CHANGED - original L3GD20_HPM_NORMAL_MODE_RES
    Gyro_FilterStructure.HighPassFilter_CutOff_Frequency = L3GD20_HPFCF_0;	//CHANGED - original L3GD20_HPFCF_0
